...
import six
from {{cookiecutter.AWS_Schema_root}}.ec2_instance_state_change_notification import (
    {{cookiecutter.AWS_Schema_name}},
)  # noqa: F401,E501
...
class AWSEvent(object):
    ...
    _types = {
        "detail": "{{cookiecutter.AWS_Schema_name}}",
        "detail_type": "str",
        "resources": "list[str]",
        "id": "str",
        "source": "str",
    ...
    def detail_type(self, detail_type):
        ...
        if detail_type is None:
            raise ValueError(
                "Invalid value for `detail_type`, must not be `None`"
            )  # noqa: E501
    ...
    def resources(self, resources):
        ...
        if resources is None:
            raise ValueError(
                "Invalid value for `resources`, must not be `None`"
            )  # noqa: E501
