...
The SAM CLI installs dependencies defined in `functions/*/Gemfile`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
```bash
{{ cookiecutter.project_name }}$ ruby tests/unit/test_stock_checker.rb
```
