...
The SAM CLI installs dependencies defined in `{{cookiecutter.function_name}}/pom.xml`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
{{cookiecutter.function_name}} mvn test
```
