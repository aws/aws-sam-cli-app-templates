...
class BuildInvoke_image_nodejs12_x_cookiecutter_aws_sam_hello_nodejs_lambda_image(Base.SimpleHelloWorldBuildInvokeBase):
    directory = "nodejs12.x-image/cookiecutter-aws-sam-hello-nodejs-lambda-image"


class BuildInvoke_image_python3_8_cookiecutter_aws_sam_hello_python_lambda_image(Base.SimpleHelloWorldBuildInvokeBase):
    directory = "python3.8-image/cookiecutter-aws-sam-hello-python-lambda-image"


class BuildInvoke_image_ruby2_7_cookiecutter_aws_sam_hello_ruby_lambda_image(Base.HelloWorldExclamationBuildInvokeBase):
...
class BuildInvoke_image_java11_cookiecutter_aws_sam_hello_java_gradle_lambda_image(
    Base.HelloWorldWithLocationBuildInvokeBase
):
...
class BuildInvoke_image_nodejs10_x_cookiecutter_aws_sam_hello_nodejs_lambda_image(Base.SimpleHelloWorldBuildInvokeBase):
...
class BuildInvoke_image_python3_7_cookiecutter_aws_sam_hello_python_lambda_image(
    (Base.SimpleHelloWorldBuildInvokeBase)
):
...
class BuildInvoke_image_ruby2_5_cookiecutter_aws_sam_hello_ruby_lambda_image(Base.HelloWorldExclamationBuildInvokeBase):
