...
class BuildInvoke_dotnetcore3_1_cookiecutter_aws_sam_hello_dotnet(Base.BuildInvokeBase):
    use_container = False
    directory = "dotnetcore3.1/cookiecutter-aws-sam-hello-dotnet"


@pytest.mark.flaky(reruns=2)
class BuildInvoke_dotnetcore3_1_cookiecutter_aws_sam_hello_step_functions_sample_app(Base.BuildInvokeBase):
    use_container = False
