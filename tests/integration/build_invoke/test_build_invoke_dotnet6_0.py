...
"""
sam build does not support to build dotnet 6.0 templates using container, 
here we put them in a separate file and use a dedicate codebuild project with .net 6.0 runtime to build them.
