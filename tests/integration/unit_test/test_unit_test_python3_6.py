...
class UnitTest_python3_6_cookiecutter_aws_sam_hello_python(UnitTestBase.Python36UnitTestBase):
    directory = "python3.6/cookiecutter-aws-sam-hello-python"
    code_directories = ["hello_world"]


class UnitTest_python3_6_cookiecutter_aws_sam_eventBridge_python(UnitTestBase.Python36UnitTestBase):
    directory = "python3.6/cookiecutter-aws-sam-eventBridge-python"
    code_directories = ["hello_world_function"]


class UnitTest_python3_6_cookiecutter_aws_sam_eventbridge_schema_app_python(UnitTestBase.Python36UnitTestBase):
...
class UnitTest_python3_6_cookiecutter_aws_sam_step_functions_sample_app(UnitTestBase.Python36UnitTestBase):
