...
class UnitTest_ruby4_0_cookiecutter_aws_sam_hello_ruby(UnitTestBase.RubyUnitTestBase):
    runtime = "ruby4.0"
    directory = "ruby/hello"
    code_directories = ["tests/unit/test_handler.rb"]
    # It can be removed after SAM CLI consumes cfn-lint that adds support for ruby4.0
    should_test_lint = False


class UnitTest_ruby4_0_cookiecutter_aws_sam_step_functions_sample_app(UnitTestBase.RubyUnitTestBase):
    runtime = "ruby4.0"
...
class UnitTest_ruby4_0_cookiecutter_quick_start_web(UnitTestBase.RubyUnitTestBase):
    runtime = "ruby4.0"
    directory = "ruby/web"
    should_test_lint = False
    code_directories = [
