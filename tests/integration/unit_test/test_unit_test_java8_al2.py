...
class UnitTest_java8_al2_cookiecutter_aws_sam_hello_java_powertools_maven(UnitTestBase.JavaUnitTestMavenBase):
    directory = "java8.al2/hello-powertools-maven"
    code_directories = ["HelloWorldFunction"]

class UnitTest_java8_al2_cookiecutter_aws_sam_hello_java_powertools_gradle(UnitTestBase.JavaUnitTestGradleBase):
    directory = "java8.al2/hello-powertools-gradle"
    code_directories = ["HelloWorldFunction"]
