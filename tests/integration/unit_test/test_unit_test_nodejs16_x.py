...
class UnitTest_nodejs16_x_cookiecutter_aws_sam_hello_typescript_nodejs(UnitTestBase.NodejsUnitTestBase):
    directory = "nodejs16.x/cookiecutter-aws-sam-hello-typescript-nodejs"
    code_directories = [ "hello-world" ]


class UnitTest_nodejs16_x_cookiecutter_aws_sam_hello_powerltools_typescript_nodejs(UnitTestBase.NodejsUnitTestBase):
    directory = "nodejs16.x/cookiecutter-aws-sam-hello-powertools-typescript-nodejs"
    code_directories = [ "hello-world" ]
