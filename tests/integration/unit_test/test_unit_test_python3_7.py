...
class UnitTest_python3_7_cookiecutter_aws_sam_hello_python(Base.Python37UnitTestBase):
    directory = "python3.7/cookiecutter-aws-sam-hello-python"
    code_directories = ["hello_world"]


class UnitTest_python3_7_cookiecutter_aws_sam_eventBridge_python(Base.Python37UnitTestBase):
    directory = "python3.7/cookiecutter-aws-sam-eventBridge-python"
    code_directories = ["hello_world_function"]


class UnitTest_python3_7_cookiecutter_aws_sam_eventbridge_schema_app_python(Base.Python37UnitTestBase):
...
class UnitTest_python3_7_cookiecutter_aws_sam_step_functions_sample_app(Base.Python37UnitTestBase):
