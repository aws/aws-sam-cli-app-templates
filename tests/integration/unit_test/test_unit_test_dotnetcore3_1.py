...
class UnitTest_dotnetcore3_1_cookiecutter_aws_sam_hello_dotnet(Base.DotNetCoreUnitTestBase):
    directory = "dotnetcore3.1/cookiecutter-aws-sam-hello-dotnet"
    code_directories = ["test/HelloWorld.Test"]


class UnitTest_dotnetcore3_1_cookiecutter_aws_sam_hello_step_functions_sample_app(Base.DotNetCoreUnitTestBase):
