...
class UnitTest_python3_14_cookiecutter_aws_sam_hello_python(UnitTestBase.Python314UnitTestBase):
...
class UnitTest_python3_14_cookiecutter_aws_sam_eventbridge_schema_app_python(UnitTestBase.Python314UnitTestBase):
...
class UnitTest_python3_14_cookiecutter_aws_sam_step_functions_sample_app(UnitTestBase.Python314UnitTestBase):
...
class UnitTest_python3_14_cookiecutter_aws_sam_efs_python(UnitTestBase.Python314UnitTestBase):
    directory = "python3.14/efs"
    code_directories = ["hello_efs"]


class UnitTest_python3_14_cookiecutter_aws_sam_quick_start_web_with_connectors(UnitTestBase.Python314UnitTestBase):
...
class UnitTest_python3_14_cookiecutter_aws_sam_step_functions_with_connectors(UnitTestBase.Python314UnitTestBase):
...
class UnitTest_python3_14_cookiecutter_aws_sam_hello_pt_python(UnitTestBase.Python314UnitTestBase):
