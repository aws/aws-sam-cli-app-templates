...
* java17 - [Install Java 17](https://docs.aws.amazon.com/corretto/latest/corretto-17-ug/downloads-list.html)
...
```bash
{{ cookiecutter.project_name }}$ cd functions/<function-name>/
