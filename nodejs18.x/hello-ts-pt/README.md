# AWS SAM cookiecutter for NodeJS TypeScript Lambda functions with AWS Lambda Powertools for TypeScript
...
Generate a new SAM based Serverless App: `sam init --runtime nodejs18.x`.
